...
{
    Q_UNUSED(spritzView); Q_UNUSED(charPos); Q_UNUSED(segmentPos); Q_UNUSED(timePos); Q_UNUSED(speed);
...
{
    Q_UNUSED(spritzView); Q_UNUSED(charPos); Q_UNUSED(segmentPos); Q_UNUSED(timePos); Q_UNUSED(speed); Q_UNUSED(numSentences);
    m_helper->firePositionChanged();
}

- (void)spritzView:(SPBaseView*)spritzView didGoForwaredSentence:(NSInteger)numSentences charPos:(NSInteger)charPos segmentPos:(NSInteger)segmentPos timePos:(NSInteger)timePos speed:(NSInteger)speed
{
    Q_UNUSED(spritzView); Q_UNUSED(charPos); Q_UNUSED(segmentPos); Q_UNUSED(timePos); Q_UNUSED(speed); Q_UNUSED(numSentences);
    m_helper->firePositionChanged();
}

- (void)spritzView:(SPBaseView*)spritzView didComplete:(NSInteger)charPos segmentPos:(NSInteger)segmentPos timePos:(NSInteger)timePos speed:(NSInteger)speed
{
    Q_UNUSED(spritzView); Q_UNUSED(charPos); Q_UNUSED(segmentPos); Q_UNUSED(timePos); Q_UNUSED(speed);
    m_helper->firePositionChanged();
    m_helper->fireReadingStateChanged();
